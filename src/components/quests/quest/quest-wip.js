      ...
      <div id="quest-component">
        <div className="header-area" style={bgStyle}>
          <div>
            ...
            <div className="sub-title"><span>Lore: The scrt wolf pack have been scattered all throughout the land.
             No one knows where the pack Alphas have gone so temporarily brave wolves must step up to gather the packs</span>
            </div>
